...
def start(update: Update, context: CallbackContext):
    context.bot.send_message(chat_id=update.effective_chat.id, text=f"Hi *{update.effective_user.first_name}*!\n\nI am subtitle downloader bot. I can provide movie or series subtitles.\n\n==> Just send me the exact Movie/series name. Use @imdb or @imdbot inline to get currect movie name.\n\nJoin ℹ️ @teamxprojects if you ❤️ using this bot!", parse_mode="Markdown")
